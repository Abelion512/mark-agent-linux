...
- **Integrasi Google Workspace:** Mengelola produktivitas Anda secara otomatis! Mark memiliki koneksi langsung ke ekosistem Google untuk membaca/mencari email di Gmail, mengatur/membaca jadwal di Google Calendar, hingga mencari, membaca, dan mengunggah dokumen di Google Drive.
- **Mark Skills System:** Ubah kepribadian dan peran Mark secara instan menggunakan instruksi *Markdown* (`.md`). Anda dapat menginstal skill kustom dari luar atau membuatnya sendiri melalui editor bawaan. Panggil skill kapan saja dengan mengetik `/nama-skill` di kotak obrolan. Anda bahkan dapat menggabungkan multi-skill dalam satu prompt (contoh: `/ppt-creator /translator tolong buatkan presentasi`)!
