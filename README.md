...
- **Proaktif dengan Awareness Engine:** Sistem Mark tidak hanya pasif merespons. Mark bisa proaktif menegur, menyapa, atau memutarkan musik di latar belakang. Aksi proaktif intrusif dibatasi oleh *Proactive Proposal Boundary*, dan kini dilengkapi fitur **Toggle** (bisa dimatikan kapan saja).
