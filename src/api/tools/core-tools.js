export const core_tools = {
  ...
  "os-open": "Membuka file/aplikasi via shell execute (xdg-open di Linux) atau URL di browser default. Query: nama executable/path atau URL raw (misal: firefox, https://google.com). DILARANG KERAS menggunakan markdown link [teks](url)! Ketik raw text saja.",
  "run-shell": "Menjalankan perintah terminal bash/zsh singkat di PC user (Linux Debian/Ubuntu). Query: perintah_shell.",
