export const core_tools = {
  ...
  "open": "Membuka aplikasi via shell execute. Query: nama executable/path atau URL raw (misal: notepad, https://google.com). DILARANG KERAS menggunakan markdown link [teks](url)! Ketik raw text saja.",
  "run-powershell": "Menjalankan perintah terminal shell singkat (bash di Linux, PowerShell di Windows). Query: perintah_shell.",
