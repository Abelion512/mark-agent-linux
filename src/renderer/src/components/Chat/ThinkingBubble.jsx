      ...
      {isSummarizing && videoId && (
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-black/10 group-hover/vid:bg-black/0 transition-colors">
            ...
            >
              <path fill="#FF0000" d="M21.582 6.186a2.686 2.686 0 0 0-1.884-1.884C18.035 3.843 12 3.843 12 3.843s-6.035 0-7.698.459a2.686 2.686 0 0 0-1.884 1.884C1.96 7.848 1.96 12 1.96 12s0 4.152.458 5.814a2.686 2.686 0 0 0 1.884 1.884C5.965 20.157 12 20.157 12 20.157s6.035 0 7.698-.459a2.686 2.686 0 0 0 1.884-1.884c.458-1.662.458-5.814.458-5.814s0-4.152-.458-5.814z" />
              <path fill="#FFFFFF" d="M9.963 15.491V8.509l6.504 3.491-6.504 3.491z" />
            </svg>
          </div>
        </button>
      )}
