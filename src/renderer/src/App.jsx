...
function App() {
  ...
  useEffect(() => {
    const checkConfig = async () => {
      ...
      // 1.6 Voice Engine (Whisper STT) — lazy: dimuat saat fitur suara dipakai pertama kali
      // Boot tidak lagi memanggil loadWhisper(); transcribeAudioLocal() memuat on-demand.
      // (Fix: sebelumnya tiap boot mengunduh ulang model → startup lambat)
